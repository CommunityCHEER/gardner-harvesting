...
const translations = {
  en: {
    ...
    manageParticipationAsAdmin: 'MANAGE PARTICIPATION (ADMIN)',
    adminParticipationTitle: 'Admin participation manager',
    adminSelectDate: 'Select date',
    adminSelectGarden: 'Select garden (required before toggling)',
    adminSwipeHint: 'Swipe left for previous day, right for next day',
    adminLoadingRoster: 'Loading roster...',
    adminNoUsers: 'No users found for this project',
    adminRefresh: 'REFRESH',
    adminClose: 'CLOSE',
    adminChecked: 'Participation logged',
    adminUnchecked: 'Not logged',
    manageUsers: 'MANAGE USERS',
    manageUsersTitle: 'Manage users',
    manageUsersLoading: 'Loading users...',
    manageUsersNoUsers: 'No users found for this project',
    manageUsersUpdateError: 'Unable to update role',
    manageUsersRoleNone: 'none',
    manageUsersRoleGard: 'gardener',
    manageUsersRoleAdm: 'admin',
    manageUsersRoleDev: 'developer',
  },
  es: {
    ...
    manageParticipationAsAdmin: 'GESTIONAR PARTICIPACION (ADMIN)',
    adminParticipationTitle: 'Administrador de participacion',
    adminSelectDate: 'Seleccionar fecha',
    adminSelectGarden: 'Seleccionar jardin (obligatorio antes de marcar)',
    adminSwipeHint: 'Desliza a la izquierda para dia anterior, derecha para dia siguiente',
    adminLoadingRoster: 'Cargando usuarios...',
    adminNoUsers: 'No se encontraron usuarios para este proyecto',
    adminRefresh: 'ACTUALIZAR',
    adminClose: 'CERRAR',
    adminChecked: 'Participacion registrada',
    adminUnchecked: 'Sin registrar',
    manageUsers: 'GESTIONAR USUARIOS',
    manageUsersTitle: 'Gestionar usuarios',
    manageUsersLoading: 'Cargando usuarios...',
    manageUsersNoUsers: 'No se encontraron usuarios para este proyecto',
    manageUsersUpdateError: 'No se pudo actualizar el rol',
    manageUsersRoleNone: 'none',
    manageUsersRoleGard: 'jardinero',
    manageUsersRoleAdm: 'administrador',
    manageUsersRoleDev: 'desarrollador',
  },
};
