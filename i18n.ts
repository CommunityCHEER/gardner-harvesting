...
const translations = {
  en: {
    ...
    noClaimsForGardens: 'Welcome to the Long Branch Gardeners Harvest mobile app.',
    refreshClaims: 'Tap here to get started.',
    ounces: 'ounces',
  ...
  es: {
    ...
    noClaimsForGardens: 'Bienvenido a la aplicación móvil Long Branch Gardeners Harvest.',
    refreshClaims: 'Toca aquí para comenzar.',
    orDivider: 'O',
